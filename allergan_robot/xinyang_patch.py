...
inputdir=r'E:/Hammer_Studio/tmp-project/咨询项目/艾尔建/爬虫项目/data_warehouse/新氧/'
df_empty=pd.DataFrame()
table = {ord(f): ord(t) for f, t in zip(u'，。！？【】（）％＃＠＆１２３４５６７８９０[]/-_#~•①②③④、&*●°@『』｛｝',
                                        u'++++++++++++1234567890++++++++++++++++++++++')} # u',.!?++()%#@&1234567890')}
city_key = ['成都','北京','西安','昆明','重庆','广州','上海']
project_key = ['双眼皮','眼泡','内眼角','开眼角''鼻部','脂肪','隆胸','除皱','瘦脸','填充','线雕','皮肤','美体','塑形','玻尿酸','自体','隆鼻','鼻尖','鼻翼','鼻头','鼻基底','塌鼻']
brand_key = ['保妥适','衡力','无品牌','润百颜','伊婉','嗨体','法思丽','乔雅登','姣兰','海薇','瑞蓝','润致','爱芙莱','舒颜','艾莉薇','德蔓','婕尔','逸美','公主','贝丽姿','皮秒','水光',
...
dose_key = ['1','2','3','4','5','6','7','8','9','0','价','ml','单位','.']
...
# print(df.loc[:, '标题'])
print(df_empty)
con = sqlite3.connect("E:/Hammer_Studio/tmp-project/咨询项目/艾尔建/爬虫项目/data_warehouse/online_data.db")
df_empty.to_sql('xinyang', con)
exit()
